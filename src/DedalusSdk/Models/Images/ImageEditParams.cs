...
/// </summary>
public record class ImageEditParams : ParamsBase
{
    ...
    public BinaryContent? Mask
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<BinaryContent>("mask");
        }
        init { this._rawBodyData.Set("mask", value); }
    }
    ...
    public ImageEditParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ImageEditParams(ImageEditParams imageEditParams)
        : base(imageEditParams)
    {
        this._rawBodyData = new(imageEditParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ImageEditParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ImageEditParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/images/edits")
        {
