...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ResponseResponseCreateParams, ResponseResponseCreateParamsFromRaw>)
)]
public sealed record class ResponseResponseCreateParams : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public ResponseResponseCreateParamsConversation? Conversation
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsConversation>(
                "conversation"
            );
        }
    ...
    /// </summary>
    public ResponseResponseCreateParamsCredentials? Credentials
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsCredentials>(
                "credentials"
            );
        }
    ...
    public IReadOnlyList<string>? Include
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<ImmutableArray<string>>("include");
        }
        init
        {
    ...
    /// </summary>
    public ResponseResponseCreateParamsInput? Input
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsInput>("input");
        }
    ...
    /// </summary>
    public ResponseResponseCreateParamsInstructions? Instructions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsInstructions>(
                "instructions"
            );
        }
    ...
    /// </summary>
    public ResponseResponseCreateParamsMcpServers? McpServers
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsMcpServers>(
                "mcp_servers"
            );
        }
    ...
    /// </summary>
    public ResponseResponseCreateParamsModel? Model
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsModel>("model");
        }
    ...
    /// </summary>
    public ResponseResponseCreateParamsPrompt? Prompt
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsPrompt>("prompt");
        }
    ...
    /// </summary>
    public ApiEnum<string, ResponseResponseCreateParamsServiceTier>? ServiceTier
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, ResponseResponseCreateParamsServiceTier>
            >("service_tier");
        }
    ...
    /// model can call.
    /// </summary>
    public ResponseResponseCreateParamsToolChoice? ToolChoice
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ResponseResponseCreateParamsToolChoice>(
                "tool_choice"
            );
        }
    ...
    /// a 400 error.
    /// </summary>
    public ApiEnum<string, ResponseResponseCreateParamsTruncation>? Truncation
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, ResponseResponseCreateParamsTruncation>
            >("truncation");
        }
    ...
    public ResponseResponseCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResponseResponseCreateParams(ResponseResponseCreateParams responseResponseCreateParams)
        : base(responseResponseCreateParams) { }
#pragma warning restore CS8618

    public ResponseResponseCreateParams(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ResponseResponseCreateParams(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ResponseResponseCreateParamsFromRaw.FromRawUnchecked"/>
    public static ResponseResponseCreateParams FromRawUnchecked(
...
class ResponseResponseCreateParamsFromRaw : IFromRawJson<ResponseResponseCreateParams>
{
    /// <inheritdoc/>
    public ResponseResponseCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ResponseResponseCreateParams.FromRawUnchecked(rawData);
}
...
/// after completion.
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsConversationConverter))]
public record class ResponseResponseCreateParamsConversation : ModelBase
{
    ...
    public ResponseResponseCreateParamsConversation(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsConversation(
        ResponseResponseCreateParamsConversationResponseConversationParam value,
    ...
    public ResponseResponseCreateParamsConversation(JsonElement element)
    {
        this._element = element;
    }
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="ResponseResponseCreateParamsConversationResponseConversationParam"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `ResponseResponseCreateParamsConversationResponseConversationParam`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    ...
    public bool TryPickResponseConversationParam(
        [NotNullWhen(true)]
            out ResponseResponseCreateParamsConversationResponseConversationParam? value
    )
    {
        value = this.Value as ResponseResponseCreateParamsConversationResponseConversationParam;
        return value != null;
    }
    ...
    public void Switch(
        ...
        Action<ResponseResponseCreateParamsConversationResponseConversationParam> responseConversationParam
    )
    {
        switch (this.Value)
        {
            case string value:
                @string(value);
                break;
            case ResponseResponseCreateParamsConversationResponseConversationParam value:
                responseConversationParam(value);
                break;
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsConversation"
                );
        }
    }
    ...
    public T Match<T>(
        ...
        Func<
            ResponseResponseCreateParamsConversationResponseConversationParam,
            T
    ...
    public static implicit operator ResponseResponseCreateParamsConversation(string value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsConversation(
        ResponseResponseCreateParamsConversationResponseConversationParam value
    ) => new(value);
    ...
    public virtual bool Equals(ResponseResponseCreateParamsConversation? other) =>
        other != null
    ...
    int VariantIndex()
    {
        ...
        {
            string _ => 0,
            ResponseResponseCreateParamsConversationResponseConversationParam _ => 1,
            _ => -1,
        };
    }
}

sealed class ResponseResponseCreateParamsConversationConverter
    : JsonConverter<ResponseResponseCreateParamsConversation?>
{
    public override ResponseResponseCreateParamsConversation? Read(
    ...
    )
    {
        ...
        {
            var deserialized =
                JsonSerializer.Deserialize<ResponseResponseCreateParamsConversationResponseConversationParam>(
                    element,
                    options
                );
    ...
    public override void Write(
        ...
        ResponseResponseCreateParamsConversation? value,
        JsonSerializerOptions options
    )
    {
...
[JsonConverter(
    typeof(JsonModelConverter<
        ResponseResponseCreateParamsConversationResponseConversationParam,
        ResponseResponseCreateParamsConversationResponseConversationParamFromRaw
    >)
)]
public sealed record class ResponseResponseCreateParamsConversationResponseConversationParam
    : JsonModel
{
    /// <summary>
    ...
    public ResponseResponseCreateParamsConversationResponseConversationParam() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResponseResponseCreateParamsConversationResponseConversationParam(
        ResponseResponseCreateParamsConversationResponseConversationParam responseResponseCreateParamsConversationResponseConversationParam
    )
        : base(responseResponseCreateParamsConversationResponseConversationParam) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="ResponseResponseCreateParamsConversationResponseConversationParamFromRaw.FromRawUnchecked"/>
    public static ResponseResponseCreateParamsConversationResponseConversationParam FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    ...
    [SetsRequiredMembers]
    public ResponseResponseCreateParamsConversationResponseConversationParam(string id)
        : this()
    {
        this.ID = id;
    }
...
class ResponseResponseCreateParamsConversationResponseConversationParamFromRaw
    : IFromRawJson<ResponseResponseCreateParamsConversationResponseConversationParam>
{
    /// <inheritdoc/>
    public ResponseResponseCreateParamsConversationResponseConversationParam FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) =>
        ResponseResponseCreateParamsConversationResponseConversationParam.FromRawUnchecked(rawData);
}
...
/// by connection name.
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsCredentialsConverter))]
public record class ResponseResponseCreateParamsCredentials : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsCredentials(Credential value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsCredentials(
    ...
    public ResponseResponseCreateParamsCredentials(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsCredentials"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsCredentials(Credential value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsCredentials(
        List<Credential> value
    ...
    public virtual bool Equals(ResponseResponseCreateParamsCredentials? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsCredentialsConverter
    : JsonConverter<ResponseResponseCreateParamsCredentials?>
{
    public override ResponseResponseCreateParamsCredentials? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsCredentials? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsInputConverter))]
public record class ResponseResponseCreateParamsInput : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsInput(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsInput(
    ...
    public ResponseResponseCreateParamsInput(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsInput"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsInput(string value) => new(value);

    public static implicit operator ResponseResponseCreateParamsInput(
    ...
    public virtual bool Equals(ResponseResponseCreateParamsInput? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsInputConverter
    : JsonConverter<ResponseResponseCreateParamsInput?>
{
    public override ResponseResponseCreateParamsInput? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsInput? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsInstructionsConverter))]
public record class ResponseResponseCreateParamsInstructions : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsInstructions(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsInstructions(
        IReadOnlyList<IReadOnlyDictionary<string, JsonValueInput?>> value,
        JsonElement? element = null
    )
    {
    ...
    public ResponseResponseCreateParamsInstructions(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsInstructions"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsInstructions(string value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsInstructions(
        List<Dictionary<string, JsonValueInput?>> value
    ) => new((IReadOnlyList<IReadOnlyDictionary<string, JsonValueInput?>>)value);
    ...
    public virtual bool Equals(ResponseResponseCreateParamsInstructions? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsInstructionsConverter
    : JsonConverter<ResponseResponseCreateParamsInstructions?>
{
    public override ResponseResponseCreateParamsInstructions? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsInstructions? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsMcpServersConverter))]
public record class ResponseResponseCreateParamsMcpServers : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsMcpServers(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsMcpServers(McpServerSpec value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsMcpServers(
    ...
    public ResponseResponseCreateParamsMcpServers(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsMcpServers"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsMcpServers(string value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsMcpServers(McpServerSpec value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsMcpServers(
    ...
    public virtual bool Equals(ResponseResponseCreateParamsMcpServers? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsMcpServersConverter
    : JsonConverter<ResponseResponseCreateParamsMcpServers?>
{
    public override ResponseResponseCreateParamsMcpServers? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsMcpServers? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
/// to browse and compare available models.
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsModelConverter))]
public record class ResponseResponseCreateParamsModel : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsModel(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsModel(DedalusModel value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsModel(
    ...
    public ResponseResponseCreateParamsModel(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsModel"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsModel(string value) => new(value);

    public static implicit operator ResponseResponseCreateParamsModel(DedalusModel value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsModel(
    ...
    public virtual bool Equals(ResponseResponseCreateParamsModel? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsModelConverter
    : JsonConverter<ResponseResponseCreateParamsModel?>
{
    public override ResponseResponseCreateParamsModel? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsModel? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
[JsonConverter(
    typeof(JsonModelConverter<
        ResponseResponseCreateParamsPrompt,
        ResponseResponseCreateParamsPromptFromRaw
    >)
)]
public sealed record class ResponseResponseCreateParamsPrompt : JsonModel
{
    /// <summary>
    ...
    public ResponseResponseCreateParamsPrompt() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResponseResponseCreateParamsPrompt(
        ResponseResponseCreateParamsPrompt responseResponseCreateParamsPrompt
    )
        : base(responseResponseCreateParamsPrompt) { }
#pragma warning restore CS8618

    public ResponseResponseCreateParamsPrompt(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ResponseResponseCreateParamsPrompt(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ResponseResponseCreateParamsPromptFromRaw.FromRawUnchecked"/>
    public static ResponseResponseCreateParamsPrompt FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    ...
    [SetsRequiredMembers]
    public ResponseResponseCreateParamsPrompt(string id)
        : this()
    {
        this.ID = id;
    }
...
class ResponseResponseCreateParamsPromptFromRaw : IFromRawJson<ResponseResponseCreateParamsPrompt>
{
    /// <inheritdoc/>
    public ResponseResponseCreateParamsPrompt FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ResponseResponseCreateParamsPrompt.FromRawUnchecked(rawData);
}
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsServiceTierConverter))]
public enum ResponseResponseCreateParamsServiceTier
{
    Auto,
    Default,
}

sealed class ResponseResponseCreateParamsServiceTierConverter
    : JsonConverter<ResponseResponseCreateParamsServiceTier>
{
    public override ResponseResponseCreateParamsServiceTier Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        {
            "auto" => ResponseResponseCreateParamsServiceTier.Auto,
            "default" => ResponseResponseCreateParamsServiceTier.Default,
            _ => (ResponseResponseCreateParamsServiceTier)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsServiceTier value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ResponseResponseCreateParamsServiceTier.Auto => "auto",
                ResponseResponseCreateParamsServiceTier.Default => "default",
                _ => throw new DedalusInvalidDataException(
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsToolChoiceConverter))]
public record class ResponseResponseCreateParamsToolChoice : ModelBase
{
    public object? Value { get; } = null;
    ...
    public ResponseResponseCreateParamsToolChoice(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ResponseResponseCreateParamsToolChoice(
    ...
    public ResponseResponseCreateParamsToolChoice(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new DedalusInvalidDataException(
                    "Data did not match any variant of ResponseResponseCreateParamsToolChoice"
                );
        }
    }
    ...
    public static implicit operator ResponseResponseCreateParamsToolChoice(string value) =>
        new(value);

    public static implicit operator ResponseResponseCreateParamsToolChoice(
    ...
    public virtual bool Equals(ResponseResponseCreateParamsToolChoice? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class ResponseResponseCreateParamsToolChoiceConverter
    : JsonConverter<ResponseResponseCreateParamsToolChoice?>
{
    public override ResponseResponseCreateParamsToolChoice? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsToolChoice? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
...
/// </summary>
[JsonConverter(typeof(ResponseResponseCreateParamsTruncationConverter))]
public enum ResponseResponseCreateParamsTruncation
{
    Auto,
    Disabled,
}

sealed class ResponseResponseCreateParamsTruncationConverter
    : JsonConverter<ResponseResponseCreateParamsTruncation>
{
    public override ResponseResponseCreateParamsTruncation Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "auto" => ResponseResponseCreateParamsTruncation.Auto,
            "disabled" => ResponseResponseCreateParamsTruncation.Disabled,
            _ => (ResponseResponseCreateParamsTruncation)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        ResponseResponseCreateParamsTruncation value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ResponseResponseCreateParamsTruncation.Auto => "auto",
                ResponseResponseCreateParamsTruncation.Disabled => "disabled",
                _ => throw new DedalusInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
