...
public class ImageEditParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        BinaryContent image = Encoding.UTF8.GetBytes("Example data");
        BinaryContent mask = Encoding.UTF8.GetBytes("Example data");

        var parameters = new ImageEditParams
        {
            Image = image,
            Prompt = "prompt",
            Mask = mask,
        ...
        BinaryContent expectedMask = mask;
        ...
        Assert.Equal(expectedMask, parameters.Mask);
    ...
    public void OptionalNullableParamsUnsetAreNotSet_Works()
    {
        ...
        var parameters = new ImageEditParams { Image = image, Prompt = "prompt" };

        Assert.Null(parameters.Mask);
        Assert.False(parameters.RawBodyData.ContainsKey("mask"));
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.Mask);
        Assert.True(parameters.RawBodyData.ContainsKey("mask"));
        Assert.Null(parameters.Model);
    ...
    public void Url_Works()
    {
        ...
        Assert.True(TestBase.UrisEqual(new Uri("https://api.dedaluslabs.ai/v1/images/edits"), url));
    }
    ...
    public void CopyConstructor_Works()
    {
        var parameters = new ImageEditParams
        {
            Image = Encoding.UTF8.GetBytes("Example data"),
            Prompt = "prompt",
            Mask = Encoding.UTF8.GetBytes("Example data"),
            Model = "model",
            N = 0,
            ResponseFormat = "response_format",
            Size = "size",
        ...
        ImageEditParams copied = new(parameters);
